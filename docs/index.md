...
# Application
An application built from https://github.com/redhat-appstudio-mjf/att6-may12-1 will be stored in [quay.io/maysunfaisal/att6-may12-1](https://quay.io/maysunfaisal/att6-may12-1) and deployed through GitOps. This application is accessible on port **8501**.